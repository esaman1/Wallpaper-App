...
public class SearchCollectionsFragment extends Fragment {
    ...
    ArrayList<ResultsItem> collectionsModels1 = new ArrayList<>();
    RecyclerView recyclerView;
    SearchCollectionAdapter adapter;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        view = inflater.inflate(R.layout.fragment_search_collections, container, false);
        recyclerView = view.findViewById(R.id.collection_Recycler);
        scrollView = view.findViewById(R.id.scrollView);
        progressBar = view.findViewById(R.id.progressBar);
        LinearLayoutManager layoutManager = new LinearLayoutManager(getActivity());
        recyclerView.setLayoutManager(layoutManager);
        collectionsModels1.clear();
        query = "backdrops";
        getCollectionData(query);
        adapter = new SearchCollectionAdapter(getActivity(), collectionsModels1);
...
//                                " pastVisible: "+pastVisiblesItems);
        ...
        ((SearchActivity) getActivity()).updateApi1(new CollectionListner() {
            @Override
            public void onBtnClick(String str) {
                SearchCollectionAdapter.collectionsModels.clear();
                query = str;
