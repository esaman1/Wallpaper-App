...
public class CollectionsFolderAdapter extends RecyclerView.Adapter<CollectionsFolderAdapter.ViewHolder> {

    ArrayList<ResultsItem> collectionsModels;
    Context context;
    ...
    public CollectionsFolderAdapter(Context contexts, ArrayList<ResultsItem> itemsData) {
        this.collectionsModels = itemsData;
        this.context = contexts;
    }

    @Override
    public CollectionsFolderAdapter.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    public void onBindViewHolder(ViewHolder viewHolder1, int position) {
        ...
        viewHolder1.imgViewIcon.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                FirebaseAnalytics("CollectionActivity", "View", "Open wallpaper of Collection");
